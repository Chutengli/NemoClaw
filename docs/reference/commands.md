...
Start auxiliary services such as the cloudflared tunnel.

```console
$ nemoclaw start
```

Messaging channels are configured during onboarding and run natively inside OpenClaw when enabled.
